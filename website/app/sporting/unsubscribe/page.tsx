...
function UnsubscribeContent() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/sporting/unsubscribe?token=${encodeURIComponent(token)}`)
      .then((res) => {
  ...
  return (
    <div style={{ backgroundColor: "#f5f4f0", minHeight: "100vh", padding: "40px 16px" }}>
      <div style={{ maxWidth: "620px", margin: "0 auto", backgroundColor: "#ffffff", padding: "48px" }}>
        ...
        {status === "loading" && (
          <p style={{ fontFamily: "Georgia, serif", fontSize: "16px", color: "#888888", lineHeight: 1.75 }}>
        ...
        {status === "success" && (
          <div>
            ...
            <p style={{ fontFamily: "Georgia, serif", fontSize: "20px", fontWeight: 700, color: "#111111", marginBottom: "16px" }}>
            ...
            <p style={{ fontFamily: "Georgia, serif", fontSize: "16px", color: "#222222", lineHeight: 1.75 }}>
              ...
              <a href="/sporting" style={{ color: "#111111", borderBottom: "1px solid #111111" }}>
                Re-subscribe here.
              </a>
            </p>
          </div>
        ...
        {status === "not_found" && (
          <div>
            ...
            <p style={{ fontFamily: "Georgia, serif", fontSize: "16px", color: "#222222", lineHeight: 1.75 }}>
              The link may have already been used, or may have expired. If you still wish to unsubscribe, please reply to any email from us.
            </p>
          </div>
        )}
        ...
        {status === "error" && (
          <div>
            ...
            <p style={{ fontFamily: "Georgia, serif", fontSize: "16px", color: "#222222", lineHeight: 1.75 }}>
              Something went wrong. Please try again or reply to any email from us to unsubscribe.
            </p>
          </div>
        )}
...
export default function SportingUnsubscribePage() {
  return (
    <Suspense
      fallback={
        <div style={{ backgroundColor: "#f5f4f0", minHeight: "100vh", padding: "40px 16px" }}>
          <div style={{ maxWidth: "620px", margin: "0 auto", backgroundColor: "#ffffff", padding: "48px" }}>
            <p style={{ fontFamily: "Georgia, serif", fontSize: "16px", color: "#888888" }}>Loading…</p>
          </div>
        </div>
      }
    >
